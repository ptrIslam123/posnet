...
net::posix::low_level::ArpViewer::HardwareType ExtractHardwareType(const uint16_t hardware)
{
    using HardwareType = net::posix::low_level::ArpViewer::HardwareType;
    switch (hardware) {
...
net::posix::low_level::ArpViewer::ProtocolType ExtractProtocolType(const uint16_t protocol)
{
    using ProtocolType = net::posix::low_level::ArpViewer::ProtocolType;
    return (protocol == 0x0800 ? ProtocolType::V4 : ProtocolType::V6);
}

net::posix::low_level::ArpViewer::OpcodeType ExtractOpcodeType(const uint16_t opcode)
{
    using OpcodeType = net::posix::low_level::ArpViewer::OpcodeType;
    switch (opcode) {
...
std::string_view HardwareTypeToStr(const net::posix::low_level::ArpViewer::HardwareType hardware)
{
    using HardwareType = net::posix::low_level::ArpViewer::HardwareType;
    switch (hardware) {
...
std::string_view ProtocolTypeToStr(const net::posix::low_level::ArpViewer::ProtocolType protocol)
{
    using ProtocolType = net::posix::low_level::ArpViewer::ProtocolType;
    return (protocol == ProtocolType::V4 ? "V4" : "V6");
}

std::string_view OpcodeTypeToStr(const net::posix::low_level::ArpViewer::OpcodeType opcode)
{
    using OpcodeType = net::posix::low_level::ArpViewer::OpcodeType;
    switch (opcode) {
...
{
    return utils::net::posix::low_level::MacAddrToStr(m_arpFrame->senderMac);
}

std::string ArpViewer::getTargetMacAddressAsStr()
{
    return utils::net::posix::low_level::MacAddrToStr(m_arpFrame->targetMac);
}

std::string ArpViewer::getSenderIpAddressAsStr()
{
    return utils::net::posix::low_level::IpAddrToStr(m_arpFrame->senderIp);
}

std::string ArpViewer::getTargetIpAddressAsStr()
{
    return utils::net::posix::low_level::IpAddrToStr(m_arpFrame->targetIp);
}
