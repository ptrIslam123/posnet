...
std::string_view ProtocolToStr(const net::posix::low_level::IpViewer::ProtocolType protocol)
{
    using ProtocolType = net::posix::low_level::IpViewer::ProtocolType;
    switch (protocol) {
...
IpViewer::IpVersionType IpViewer::getVersion()
{
    return (m_ipFrame->version == 4 ? IpVersionType::V4 : IpVersionType::V6);
}
...
{
    return utils::net::posix::low_level::IpAddrToStr(m_ipFrame->saddr);
}

std::string IpViewer::getDestIpAddressAsStr()
{
    return utils::net::posix::low_level::IpAddrToStr(m_ipFrame->daddr);
}

IpViewer::IpVersionType IpViewer::getVersion() const
{
    return (m_ipFrame->version == 4 ? IpVersionType::V4 : IpVersionType::V6);
}
...
std::ostream& IpViewer::operator<<(std::ostream& os) const
{
    ...
    os << "\tversion=";
    switch (getVersion()) {
        case IpVersionType::V4: {
            os << "IPv4";
            break;
        }
        case IpVersionType::V6: {
            os << "IPv6";
            break;
        }
    }
