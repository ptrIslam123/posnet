...
void DumpToHexFormat(std::ostream& os, std::span<std::uint8_t> data, int lineSize = 32);
void DumpToHexFormat(std::ostream& os, std::span<const std::uint8_t> data, int lineSize = 32);
